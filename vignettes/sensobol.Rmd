---
title: "sensobol: Swift Computation of Sobol' Sensitivity Indices"
author: "Arnald Puy"
date: "`r Sys.Date()`"
output: 
  html_document:
...
We can access and check the bootstrap replicas of the first and total-order indices as follows:

```{r boot_replicas, fig.height=5, fig.width=5, fig.cap="Distribution of the bootstrap replicas."}
