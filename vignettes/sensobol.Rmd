...
To visualize the Sobol' indices, use the `plot_sobol` function with type = 1. For second and third-order indices, use type = 2 and type = 3 respectively. Smaller confidence intervals will
